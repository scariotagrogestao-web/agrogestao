  ...
  return (
    <div className={`relative inline-block text-left ${className}`} ref={containerRef}>
      ...
      <button
        ...
        className="px-4 py-2.5 bg-gradient-to-r from-[#002046] to-slate-800 hover:from-slate-800 hover:to-slate-900 text-white font-sans text-xs tracking-wider uppercase font-bold rounded-xl shadow-md hover:shadow-lg transition-all duration-200 flex items-center gap-2 cursor-pointer border-none disabled:opacity-50 select-none active:scale-[0.98]"
        aria-haspopup="true"
      ...
      {isOpen && (
        <div 
          className="absolute right-0 mt-2 w-56 bg-white/95 backdrop-blur-md border border-slate-200/90 rounded-2xl shadow-2xl py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200 divide-y divide-slate-100"
          role="menu"
        >
          ...
          <div className="py-1">
            ...
            {onExportPDF && (
              <button
                ...
                className="w-full text-left px-3.5 py-2.5 text-xs font-semibold text-slate-700 hover:bg-slate-50 hover:text-slate-900 flex items-center gap-2.5 transition-colors cursor-pointer border-none bg-transparent"
                role="menuitem"
              >
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-slate-800">Documento PDF</span>
            ...
            {onExportXLSX && (
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-slate-800">Planilha Excel</span>
            ...
            {onExportCSV && (
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-slate-800">Arquivo CSV</span>
